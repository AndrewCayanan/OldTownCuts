...
$query = "SELECT id, service_name, description, price FROM services";
...
<head>
    ...
    <title>Manage Services | Old Town Cuts</title>
            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <a href="delete_service.php?id=<?php echo $row['id']; ?>" class="delete" onclick="return confirm('Are you sure?');">Delete</a>
                    </td>
                </tr>
            <?php endwhile; ?>
        </table>
