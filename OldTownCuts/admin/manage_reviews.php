...
$query = "SELECT reviews.id, users.name AS customer_name, 
                 rating, comment 
          FROM reviews 
...
<head>
    ...
    <title>Manage Reviews | Old Town Cuts</title>
        ...
        <table>
            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td class="actions">
                        <a href="delete_review.php?id=<?php echo $row['id']; ?>" class="delete" onclick="return confirm('Are you sure?');">Delete</a>
                    </td>
                </tr>
            <?php endwhile; ?>
        </table>
