...
$query = "SELECT id, name, specialty FROM barbers";
...
<head>
    ...
    <title>Manage Barbers | Old Town Cuts</title>
...
<body>
    ...
    <section class="container">
        ...
        <a href="add_barber.php" class="add-btn">+ Add New Barber</a>
        <table>
            <tr>
                <th>ID</th>
                <th>Name</th>
            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td class="actions">
                        <a href="update_barber.php?id=<?php echo $row['id']; ?>" class="edit">Edit</a>
                        <a href="delete_barber.php?id=<?php echo $row['id']; ?>" class="delete" onclick="return confirm('Are you sure?');">Delete</a>
                    </td>
                </tr>
            <?php endwhile; ?>
        </table>
